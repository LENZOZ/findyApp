...
const NavBarHome = () => {
  ...
  //const tipo=JSON.parse(auth).Local_id_local
  console.log(auth);
  const logout = () => {
    localStorage.clear();
    navigate("/home");
    ...
    <div>
      <Navbar className="navBg" expand="lg" variant="dark">
        <Container fluid>
          ...
          {authA ? (
                    <><Nav.Link onClick={logout} as={Link} to="/login" align="right">
          ...
          <Navbar.Collapse in={open} className="justify-content-end">
            <Nav>
              {auth ? (
                <>
                      ...
                      >
                        <NavDropdown.Item>
                          <Nav.Link as={Link} to="/login">
                            <Button variant="dark">¡Soy Cliente!</Button>
                          </Nav.Link>
                        </NavDropdown.Item>
                        <NavDropdown.Divider />
                        <NavDropdown.Item>
                          <Link to="/loginAdmin" align="left">
                            <Button variant="dark">¡Soy administrador!</Button>
                          </Link>
                        </NavDropdown.Item>
                      </NavDropdown>
